 ...
 * Генерує кілька імен
 */
function generateMultipleNames(array $syllables, int $namesCount = 5, int $syllablesPerName = 2): array
{
    $names = [];
...
$syllablesInput = $_POST['syllables'] ?? 'гу ма ні ро та ше бі ку лі зо';
