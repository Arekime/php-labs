...
$text = $_POST['text'] ?? 'Футбольна команда з невеликого містечка здобула перемогу на національному чемпіонаті вперше за двадцять років своєї історії';
$find = $_POST['find'] ?? '';
