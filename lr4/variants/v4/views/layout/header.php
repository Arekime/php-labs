...
$navItems = [
    ...
    'reqview/showrequest' => 'Меню піццерії та замовлення',
...
<head>
    ...
    <title><?= htmlspecialchars(($pageTitle ?? '') !== '' ? $pageTitle : 'Піцерія') ?> — Піцерія</title>
    ...
    <header class="header">
        <div class="container">
            <div class="header__inner">
                <a href="index.php" class="header__logo">Піцерія</a>
                <?php if ($greetingText !== ''): ?>
